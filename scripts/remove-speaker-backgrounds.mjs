...
const API_KEY = process.env.SITE_API_KEY || process.env.GCONF_API_KEY;

if (!API_KEY) {
  console.error('SITE_API_KEY or GCONF_API_KEY is not set. Export it before running this script:');
  console.error('  export SITE_API_KEY=<your-key>');
  process.exit(1);
}
