...
export const Hero: React.FC<HeroProps> = ({ data, onOpenContact, onOpenSpeakerApp, onOpenWaitlist }) => {
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#F2F4F7] pt-4 pb-12 md:pt-0 md:pb-10">
      ...
      <div className="relative z-20 flex flex-col items-center text-center w-full max-w-[1440px] space-y-6 md:space-y-10 px-4 md:px-6">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-blue-200/50 bg-white/60 backdrop-blur-md animate-fade-in-up" style={{ boxShadow: '0 0 8px 1px rgba(13,80,200,0.10), 0 0 16px 2px rgba(13,80,200,0.05)' }}>
        ...
        <div className="space-y-4 md:space-y-6 animate-fade-in-up [animation-delay:200ms] opacity-0 fill-mode-forwards w-full">
          ...
          <p className="text-lg md:text-2xl text-[#0D70EB] font-sans font-bold max-w-3xl mx-auto leading-relaxed tracking-wide px-2">
            {data.subheadline}
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 md:gap-4 py-2 md:py-4 animate-fade-in-up [animation-delay:400ms] opacity-0 fill-mode-forwards font-sans w-full sm:w-auto">
          <div className="flex items-center justify-center gap-2 md:gap-3 px-4 py-2 md:px-6 md:py-3 rounded-full border border-blue-200/40 bg-white/60 backdrop-blur-sm hover:bg-white/80 transition-all duration-300 cursor-default min-w-fit w-full sm:w-auto" style={{ boxShadow: '0 0 8px 1px rgba(13,80,200,0.10), 0 0 16px 2px rgba(13,80,200,0.05)' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-4 pt-4 md:pt-6 items-center w-full sm:w-auto animate-fade-in-up [animation-delay:600ms] opacity-0 fill-mode-forwards flex-wrap justify-center">
          ...
          <button
            ...
            className="px-6 py-3 md:px-8 md:py-4 rounded-full text-sm md:text-base font-bold text-slate-800 hover:text-brand-blue transition-all duration-300 border border-blue-200/40 hover:border-brand-blue/40 bg-white/50 hover:bg-white backdrop-blur-sm flex items-center justify-center gap-3 w-full sm:w-auto whitespace-nowrap" style={{ boxShadow: '0 0 15px 3px rgba(13,80,200,0.10), 0 0 30px 6px rgba(13,80,200,0.05)' }} onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 0 25px 6px rgba(13,80,200,0.20), 0 0 50px 12px rgba(13,80,200,0.10)'; }} onMouseLeave={(e) => { e.currentTarget.style.boxShadow = '0 0 15px 3px rgba(13,80,200,0.10), 0 0 30px 6px rgba(13,80,200,0.05)'; }}
          >
