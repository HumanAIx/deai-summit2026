...
export const Toast: React.FC<ToastProps> = ({ message, isVisible, onClose }) => {
  ...
  return (
    <div className="fixed bottom-8 left-0 right-0 z-[100] flex justify-center pointer-events-none">
      <div className="bg-[#020408] text-white px-6 py-3 rounded-full shadow-2xl border border-white/10 flex items-center gap-3 animate-fade-in-up pointer-events-auto">
